...
SMTP_PORT = 25
SENDER_EMAIL = "NewGen-Automation@comviva.com"
...
FILE_PATTERNS = {
    ...
    "Ooredoo_Kuwait_RBT": "Ooredoo_Kuwait_RBT",
...
def main():
    ...
    if missing_files:
        ...
        for file_key, pattern in missing_files.items():
            ...
            <p style="color: #ff0000; font-weight: bold;">{product_name} ticket data is not received today. Please check ....</p>
