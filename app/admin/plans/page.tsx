...
export default function PlansPage() {
  ...
  const handleExportPlans = () => {
    ...
    toast.success("Plans data exported successfully!")
  }
  ...
  const handleViewPlan = (plan: any) => {
    toast.info(`Viewing plan: ${plan.name}`)
  ...
  const handleViewSubscription = (subscription: any) => {
    toast.info(`Viewing subscription: ${subscription.id}`)
    console.log("View subscription:", subscription)
  }

  const handleEditSubscription = (subscription: any) => {
    toast.info(`Editing subscription: ${subscription.id}`)
    console.log("Edit subscription:", subscription)
  }

  const handleCancelSubscription = (subscription: any) => {
    if (confirm(`Are you sure you want to cancel subscription ${subscription.id}?`)) {
      toast.success(`Subscription ${subscription.id} cancelled successfully`)
      console.log("Cancel subscription:", subscription)
    }
  }

  const handleRenewSubscription = (subscription: any) => {
    toast.success(`Subscription ${subscription.id} renewed successfully`)
