      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-orange-100">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-gray-900">{activeVendors}</div>
              <p className="text-sm text-gray-500 mt-2">Verified suppliers</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="products" className="space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <TabsList className="grid w-full max-w-lg grid-cols-3 bg-gray-100 p-1 rounded-lg">
              ...
              <TabsTrigger value="vendors" className="data-[state=active]:bg-white data-[state=active]:shadow-sm">
                Vendors
              </TabsTrigger>
            </TabsList>
            <div className="flex items-center space-x-2">
              <Button variant="outline" size="sm" onClick={fetchMarketplaceData} disabled={loading}>
                    ...
                    <TableBody>
                      {orders.map((order) => (
                        <TableRow key={order.orderId}>
                          ...
                          <TableCell>
                            <div>
                              <div className="font-medium">{order.operatorName || order.operatorId}</div>
                              <div className="text-sm text-gray-500">{order.operatorId}</div>
                            </div>
                          </TableCell>
                          <TableCell>
                            <div className="font-medium">{order.productName || order.productId}</div>
                          </TableCell>
                          ...
                          <TableCell>
                            <div className="flex items-center space-x-2">
                              ...
                              <Button variant="ghost" size="icon" onClick={() => handleTrackOrder(order)}>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">{vendor.profileDetail.name}</p>
                              </div>
                            </div>
